...
def getAppointmentPage(driver):
    ...
    driver.get("https://www27.state.nj.us/tc/NJ_SelectOptions.do?method=nextLocation&domObject=appointment&domProperty=select_location&LocationId=6&LocationName=Lodi&reschedule=false&cmd=donext&process=driver_testing_client&process2=driver_testing_client&entry=&level=&urlstring=njmvcdtclient&step=Select+Location&locationSearchType=1&location_zip=07620&location_countyId=1&location_city=&location_location=")
    sleep(1)
